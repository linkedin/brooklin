 ...
 * creating new topics on destination side whenever a new source topic is detected).
 */
public interface TopicManager {

  /**
   * This gets called before calling Kafka Poll(), in case any topic management needs to be done.
   */
