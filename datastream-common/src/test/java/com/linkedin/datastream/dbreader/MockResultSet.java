...
/**
 * Simple mock which right not only supports APIs needed by DatabaseChunkedReader. It only supports 'TYPE_FORWARD_ONLY'
 * cursor at this point.
 */
public class MockResultSet implements ResultSet {
  List<DatabaseRow> _databaseRows;
  ...
  public boolean next() throws SQLException {
    if (_rowIter == null) {
      _rowIter = _databaseRows.iterator();
    }
  ...
  public ResultSetMetaData getMetaData() throws SQLException {
    return new MockResultSetMetaData(_currentRow);
  }

  @Override
  public Object getObject(int columnIndex) throws SQLException {
    // getObject parameter index starts at 1
    return _currentRow.getRecords().get(columnIndex - 1).getValue();
  }
  ...
  public Object getObject(String columnLabel) throws SQLException {
    ...
    String msg = String.format("Column %s not in ResultSet record", columnLabel);
  ...
  class MockResultSetMetaData implements ResultSetMetaData {
    ...
    public String getColumnName(int column) throws SQLException {
      DatabaseColumnRecord col = _row.getRecords().get(column - 1);
