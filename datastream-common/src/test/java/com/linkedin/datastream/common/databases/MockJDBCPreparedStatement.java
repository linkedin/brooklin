...
public class MockJDBCPreparedStatement implements PreparedStatement {
  ...
  public ResultSet executeQuery() throws SQLException {
    ...
    return new MockResultSet(_dataMap.get(_startIndex + _callCount++));
  }
  ...
  public void setObject(int parameterIndex, Object x) throws SQLException {
    Assert.assertEquals(((DatabaseColumnRecord) _keyMap.get(_callCount).get(parameterIndex)).getValue(), x);
  }
