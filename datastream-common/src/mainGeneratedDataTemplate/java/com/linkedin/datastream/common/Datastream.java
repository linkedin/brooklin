    ...
    extends RecordTemplate
{
    ...
    private final static RecordDataSchema SCHEMA = ((RecordDataSchema) DataTemplateUtil.parseSchema("{\"type\":\"record\",\"name\":\"Datastream\",\"namespace\":\"com.linkedin.datastream.common\",\"doc\":\"Extensible data model of Datastream\",\"fields\":[{\"name\":\"name\",\"type\":\"string\",\"doc\":\"This is the name of the Datastream.\"},{\"name\":\"connectorType\",\"type\":\"string\",\"doc\":\"Type of the connector to be used for reading the real time change capture events from the source, e.g. Oracle, Espresso, Mysql etc..\"},{\"name\":\"source\",\"type\":\"string\",\"doc\":\"Source string that connector can use to properly connect to the database.\"},{\"name\":\"target\",\"type\":[{\"type\":\"record\",\"name\":\"KafkaConnection\",\"fields\":[{\"name\":\"topicName\",\"type\":\"string\",\"doc\":\"Name of the kafka topic.\"},{\"name\":\"kafkaMetadataBrokers\",\"type\":\"string\",\"doc\":\"Comma separated list of kafka metadata brokers.\"}]}],\"doc\":\"Target kafka cluster and topic connector will use for this Datastream. Will be populated by connector by default.\",\"optional\":true},{\"name\":\"metadata\",\"type\":{\"type\":\"map\",\"values\":\"string\"},\"doc\":\"Generic metadata for Datastream (e.g. owner, expiration, etc). Metadatas are stored as user-defined name/value pair.\",\"optional\":true}]}"));
        ...
        extends PathSpec
    {
        ...
        /**
         * Source string that connector can use to properly connect to the database.
         * 
         */
        ...
        /**
         * Target kafka cluster and topic connector will use for this Datastream. Will be populated by connector by default.
         * 
         */
