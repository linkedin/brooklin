...
public class Datastream extends RecordTemplate {
  ...
  @Override
  public Datastream clone() throws CloneNotSupportedException {
    return ((Datastream) super.clone());
  }

  @Override
  public Datastream copy() throws CloneNotSupportedException {
  ...
  @Generated(
      value = "com.linkedin.pegasus.generator.PegasusDataTemplateGenerator",
      comments = "LinkedIn Data Template. Generated from /Users/pdu/datastream/Datastream/datastream-common/src/main/pegasus/com/linkedin/datastream/common/Datastream.pdsc.",
      date = "Fri Sep 04 16:17:04 PDT 2015")
  public final static class Target extends UnionTemplate {

    private final static UnionDataSchema SCHEMA =
        ((UnionDataSchema) DataTemplateUtil
            .parseSchema("[{\"type\":\"record\",\"name\":\"KafkaConnection\",\"namespace\":\"com.linkedin.datastream.common\",\"fields\":[{\"name\":\"topicName\",\"type\":\"string\",\"doc\":\"Name of the kafka topic.\"},{\"name\":\"partitions\",\"type\":\"int\",\"doc\":\"Number of partitions of the kafka topic.\"},{\"name\":\"metadataBrokers\",\"type\":\"string\",\"doc\":\"Comma separated list of kafka metadata brokers.\"}]}]"));
    private final static DataSchema MEMBER_KafkaConnection = SCHEMA
        .getType("com.linkedin.datastream.common.KafkaConnection");
    ...
    public com.linkedin.datastream.common.KafkaConnection getKafkaConnection() {
      return obtainWrapped(MEMBER_KafkaConnection, com.linkedin.datastream.common.KafkaConnection.class,
          "com.linkedin.datastream.common.KafkaConnection");
    }

    public void setKafkaConnection(com.linkedin.datastream.common.KafkaConnection value) {
      selectWrapped(MEMBER_KafkaConnection, com.linkedin.datastream.common.KafkaConnection.class,
          "com.linkedin.datastream.common.KafkaConnection", value);
    }

    @Override
    public Datastream.Target clone() throws CloneNotSupportedException {
      return ((Datastream.Target) super.clone());
    }

    @Override
    public Datastream.Target copy() throws CloneNotSupportedException {
    ...
    public static class Fields extends PathSpec {
      ...
      public com.linkedin.datastream.common.KafkaConnection.Fields KafkaConnection() {
        return new com.linkedin.datastream.common.KafkaConnection.Fields(getPathComponents(),
            "com.linkedin.datastream.common.KafkaConnection");
      }
