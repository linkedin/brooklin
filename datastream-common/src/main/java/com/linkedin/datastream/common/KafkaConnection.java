...
public class KafkaConnection extends RecordTemplate {
  ...
  @Override
  public KafkaConnection clone() throws CloneNotSupportedException {
    return ((KafkaConnection) super.clone());
  }

  @Override
  public KafkaConnection copy() throws CloneNotSupportedException {
