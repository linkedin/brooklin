...
public class TestLoadbalancingStrategy {
  ...
  @Test
  public void testLoadbalancingStrategy_DistributesTasksAcrossInstancesEqually() {
  ...
  @Test
  public void testLoadbalancingStrategy_CreatesTasksOnlyForPartitionsInDestination() {
    String[] instances = new String[] { "instance1", "instance2", "instance3" };
    List<Datastream> datastreams =  Arrays.asList(DatastreamTestUtils.createDatastreams(DummyConnector.CONNECTOR_TYPE, "ds1"));
    datastreams.forEach(x -> {
      x.setDestination(new DatastreamDestination());
  ...
  @Test
  public void testLoadbalancingStrategy_RedistributesTasksWhenNodeGoesDown() {
    String[] instances = new String[] { "instance1", "instance2", "instance3" };
    List<Datastream> datastreams =  Arrays.asList(DatastreamTestUtils.createDatastreams(DummyConnector.CONNECTOR_TYPE, "ds1"));
    datastreams.forEach(x -> {
      x.setDestination(new DatastreamDestination());
    ...
    Assert.assertTrue(newAssignment.get(newInstances[0]).containsAll(assignment.get(newInstances[0])));
    Assert.assertTrue(newAssignment.get(newInstances[1]).containsAll(assignment.get(newInstances[1])));
  }

  @Test
  public void testLoadbalancingStrategy_RedistributesTasksWhenNodeIsAdded() {
    ...
    Assert.assertTrue(assignment.get(instances[0]).containsAll(newAssignment.get(instances[0])));
    Assert.assertTrue(assignment.get(instances[1]).containsAll(newAssignment.get(instances[1])));
  }

  @Test
  public void testLoadbalancingStrategy_DoesntRedistributeExistingTasksWhenNewDatastreamIsAdded() {
    String[] instances = new String[] { "instance1", "instance2", "instance3" };
    List<Datastream> datastreams =  Arrays.asList(DatastreamTestUtils.createDatastreams(DummyConnector.CONNECTOR_TYPE, "ds1"));
    datastreams.forEach(x -> {
      x.setDestination(new DatastreamDestination());
    ...
    for (String instance : instances) {
      ...
      Assert.assertTrue(newAssignment.get(instance).containsAll(assignment.get(instance)));
    }
  }

  // Datastream delete is still not supported.
  @Test(enabled = false)
  public void testLoadbalancingStrategy_DoesntRedistributeExistingTasksWhenDatastreamIsDeleted() {
    String[] instances = new String[] { "instance1", "instance2", "instance3" };
    ...
    for (String instance : instances) {
      ...
      Assert.assertTrue(assignment.get(instance).containsAll(newAssignment.get(instance)));
    }
  }
}
