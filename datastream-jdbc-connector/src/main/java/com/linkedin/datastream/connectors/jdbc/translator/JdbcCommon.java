 ...
 *
 * This file was copied from https://github.com/apache/nifi and adapted to support T-SQL data types
 */
...
public class JdbcCommon {
    ...
    /**
     * Converts resultset to Avro stream
     *
     * @param rs The result set to convert to Avro
     * @param outStream Output stream in Avro
     * @param convertNames Option to normalize name for Avro
    ...
    /**
     * Create empty Avro stream
     *
     * @param outStream Output stream in Avro
     * @throws IOException if any error occurs during creation
     */
    public static void createEmptyAvroStream(final OutputStream outStream) throws IOException {
        final FieldAssembler<Schema> builder = SchemaBuilder.record(AVRO_SCHEMA_RECORD_NAME).namespace(AVRO_SCHEMA_NAMESPACE).fields();
    ...
    public static class AvroConversionOptions {
        ...
        public static class Builder {
            ...
            /**
             * Setter method for convertNames
             * @param convertNames
             * @return Builder
             */
            ...
            /**
             * Setter method for useLogicalTypes
             * @param useLogicalTypes
             * @return Builder
             */
            ...
            /**
             * Setter method for defaultPrecision
            ...
            /**
             * Builder method
             * @return Avro conversion options
             */
     ...
     * @param rs The result set to convert to Avro
     * @param outStream Output stream in Avro
     * @param options Options for Avro conversion
     * @return Number of rows in the result set
     * @throws SQLException if any error occurs during conversion
     */
    public static long convertToAvroStream(final ResultSet rs, final OutputStream outStream, final AvroConversionOptions options,
                                           final ResultSetRowCallback callback)
            throws SQLException, IOException {
    ...
    public static Schema createSchema(final ResultSet rs, AvroConversionOptions options) throws SQLException {
        final ResultSetMetaData meta = rs.getMetaData();
        final int nrOfColumns = meta.getColumnCount();
        String tableName = StringUtils.isEmpty(options.recordName) ? AVRO_SCHEMA_RECORD_NAME : options.recordName;
        if (nrOfColumns > 0) {
    ...
    /**
     * Normalize string to be Avro compatible
     *
     * @param inputName Input value to normalize
        ...
        for (final Map.Entry<String, String> entry : attributes.entrySet()) {
            ...
            if (matcher.matches()) {
                ...
                try {
                    ...
                    throw new SQLDataException("The value of the " + valueAttrName + " is '" + parameterValue
                            + "', which cannot be converted into the necessary data type", nfe);
                } catch (ParseException pe) {
                    throw new SQLDataException("The value of the " + valueAttrName + " is '" + parameterValue
                            + "', which cannot be converted to a timestamp", pe);
                } catch (UnsupportedEncodingException uee) {
                    throw new SQLDataException("The value of the " + valueAttrName + " is '" + parameterValue
                            + "', which cannot be converted to UTF-8", uee);
                }
            }
        }
    }
     ...
     */
    public static void setParameter(final PreparedStatement stmt, final String attrName, final int parameterIndex,
                                    final String parameterValue, final int jdbcType,
